...
export function buildParavartyaTwo(p: any): LessonModel {
  ...
  frames.push({
    cap: `Step 2: Process columns using transpose-and-multiply`,
    log: [
  ...
  return {
    title: 'Paravartya Yojayet - Two Digits',
    ruleHTML: 'Transpose and Apply',
    frames,
    note: 'Division by two digits using flag technique.'
  };
}
